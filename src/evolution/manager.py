...
class evolution(object):
    ...
    def initialize(self, console = None):
        ...
        if console:
            print(' is initialized',self.name)
        return
    ...
    def evaluate(self, console = None):
        ...
        for g in self.current_generation:
            ...
            g.grade = result
            if console:
                print(' evaluation result: ',g.name, result)
        ...
        if console:
            print('Generation  of  : evaluation complete', self.generation_count, self.name)
        return
    ...
    def apply_selection(self, console = None):
        ...
        print('applied selection on generation ',self.name, self.generation_count)
    ...
    def reproduce(self, console = None):
        ...
        print('reproducing of generation started',self.name, self.generation_count)
        ...
        while self.current_generation:
            ...
            print('Hijos   padres ', child_1.name, child_2.name, parent_1.name, parent_2.name)
        ...
        self.save_genomes()
        self.state = 'evaluate'
        print('created generation ',self.name, self.generation_count)
